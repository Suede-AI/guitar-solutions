        ...
        <div className="lg:col-span-9">
          ...
          <div className="mt-12 border-t border-paper-dim/20 pt-8">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-paper-dim">
              ...
              <a href="https://www.amazon.com/author/jason-colapietro" target="_blank" rel="noopener" className="hover:text-cyan transition-colors">The Guitar Without a Number</a>
